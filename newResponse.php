<?php
  ...
  if($response['HotelSearchResult']['ResponseStatus'] == 1){
      ...
      $index1 = $response['HotelSearchResult']['HotelResults'][$i]['ResultIndex'];
      $code1 = $response['HotelSearchResult']['HotelResults'][$i]['HotelCode'];
      $trace1 = $response['HotelSearchResult']['TraceId'];
      ...
      if($responseHotelInfo['HotelInfoResult']['ResponseStatus'] == 1){
        ...
        if($maxFacilities > 0){
          ...
          echo '<br>';
          for($z = 0; $z < $maxFacilities; $z++){
            echo '@ '.$responseHotelInfo['HotelInfoResult']['HotelDetails']['HotelFacilities'][$z].'<br>';
          }
        }
      }
      else{
