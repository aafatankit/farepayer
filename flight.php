											...
											<div class="col-sm-12 mt">
												<section>
													...
													<select class="cs-select cs-skin-border">
														...
														<option value="DIRST">Dirst</option>
...
<!--Slider end-->
  <div class="container-fluid">
    <div class="row">
		<div class="col-md-12" style="margin-top:-150px "><h1 class="text-center" style="font-size:30px">Top Flight Booking Offers</h1><p></p><br><br>
...
<div class="container-fluid">
						...
						<b>Let’s Enjoy Excellent Flight Packages</b>
						<br>
