...
<div class="row">
<div class="container">
<div class="alert alert-success fa-2x" style="background:#4dd0e1;color: white; border-radius: 5px"><strong>Booking successful ..</strong> </div>

<div class="col-md-9">

<div class="col-md-12">
<h3 class=" text-white p-2 text-center"style="background: #1976d2">Booking Details</h3>
<table class="table"style="border: solid 1px #dddddd;">
    <thead>
      <tr>
        <th>InvoiceNumber </th>
        <th>MW/1819/13578</th>
        ...
        <th><u>Last cancellation date</u></th>
        <th><u>14/2/2019</u></th>
	...
	<div class="col-md-3">
	<h3 class="text-white p-2 text-center" style="background: #03a9f4">Price Details</h3>
	<table class="table"style="border: solid 1px #dddddd;">
    <thead>
      <tr>
        <th>Room 1 </th>
