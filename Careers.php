...
<div class="container">
<i class="fa fa-home fa-2x"></i><a href="index.php">Home</a> <i class="fa fa-angle-right fa-2x"></i><a href="Careers.php">Careers</a>
   </div>
   </div>
 <br>
 <p></p>
...
<h1 class="mt-3 pb-3 mb-4 font-italic border-bottom">
   ...
   <div class="row">
      <div class="col-md-4">
         <div class="card">
            <img class="card-img-top" src="images/careers/job1.jpg" alt="Card image cap">
            <div class="card-body">
               <h5 class="card-title border-bottom pb-3">Job title <a href="#" class="float-right d-inline-flex share"><i class="fa fa-bullhorn" aria-hidden="true"></i></a></h5>
